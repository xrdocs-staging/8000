...
## Conclusion
This document briefs fundamental architecture of Cisco 8000 series router powered by SiOne NPU co-packaged with HBM. QOS architecture explained in this document is applicable to all SiOne NPU generations except some of the additions like Egress Feature Capability (EFC) , Priority propagation features etc. which are recent additional capbilities on latest SiOne variants like P100/K100. And these changes will be documented in upcoming write ups.
